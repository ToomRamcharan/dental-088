        ...
        <div className="grid lg:grid-cols-2 gap-12">
          <Motion variants={fadeUp} className="space-y-6">
            <div className="flex items-start gap-4">
              ...
              <div><h3 className="font-semibold font-heading">Address</h3><p className="text-foreground-muted text-sm mt-1">Wyra Rd, opp. to Rohit Test Tube Baby Centre, above Titan Watch Showroom, Nehru Nagar, Khammam - 507001</p></div>
            </div>
            <div className="flex items-start gap-4">
            ...
            <div className="flex items-start gap-4">
              ...
              <div><h3 className="font-semibold font-heading">Email</h3><p className="text-foreground-muted text-sm mt-1"><a href="mailto:online@parthadental.com" className="hover:text-primary">online@parthadental.com</a></p></div>
            </div>
            <div className="flex items-start gap-4">
